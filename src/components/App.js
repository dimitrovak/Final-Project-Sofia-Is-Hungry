...
class App extends Component {
    ...
    componentWillReceiveProps({
        ...
        // Check if script is loaded and map is defined
    ...
    toggleList = () => {
        ...
        if (width < 600) {
            // Close infowindow if listview is open
            if (!listOpen) {
                infowindow.close();
            }
            this.setState({
    ...
    render() {
        ...
        return ( <
            ...
            <
            h1 className = "app-title" > Sofia is hungry < /h1> <
            hr / > { /* render markers only when map has loaded */
                mapReady ?
                <
                ListView
                map = {
            ...
            role = "application" > {
                ...
                className = "error"
                role = "alert" >
                Google Maps did not load.Please
                try again later...
                <
                /div> : <
